...
import RipToken from "./contracts/RipToken.json";
import RipTokenSale from "./contracts/RipTokenSale.json";
...
class App extends Component {
  ...
  componentDidMount = async () => {
    try {
        ...
        this.myToken = new this.web3.eth.Contract(
          RipToken.abi,
          RipToken.networks[this.networkId] && RipToken.networks[this.networkId].address,
        );

        this.myTokenSale = new this.web3.eth.Contract(
         RipTokenSale.abi,
         RipTokenSale.networks[this.networkId] && RipTokenSale.networks[this.networkId].address,
        );
  ...
  updateUserTokens = async () => {
    let userTokens = await this.RipToken.balanceOf(this.accounts[0]).call();
  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        <p>Current Amount: {this.state.userTokens}</p>
